...
# typeset -g POWERLEVEL9K_INSTATNT
...
#
# -------- Fuzzy finding stufss ---------------
# eval "$(fzf --zsh)"
alias fd="fdfind"
export FZF_DEFAULT_COMMAND="fdfind --hidden --strip-cwd-prefix --exclude .git --exclude node_modules --exclude py_cache"
...
# pnpm
export PNPM_HOME="/home/coder-vasen/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
